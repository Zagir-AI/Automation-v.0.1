...
# ── Вкладка: НО / ЭН (наружные сети освещения) ──────────────────────
# НО = наружное освещение, ЭН = наружные сети электроосвещения — оба раздела
# используют outdoor_networks[]. ЭС (электроснабжение) — отдельная дисциплина.
