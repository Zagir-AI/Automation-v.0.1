...
- `breaker_min_rating` (на панели) — минимальный номинал вводного АВ щита (для соблюдения селективности)
...
- isc_ka = 3.0 (офис, ~100м от ТП) → 6 нарушений термо-КЗ питающих кабелей (норма для DEMO)

### Ожидаемые значения для ТЕСТ (школа):
- Pуст = 79.0 кВт
- Pрасч = 59.9 кВт  (НО-02 — reserve=true)
- cosφ = 0.897
- Iвру = 101.42 А
- Кабель ВРУ: ВВГнг-LS 4×50 мм²
- АВ ВРУ: 125А хар.C
- ЩАПЗ-1: ВВГнг-FRLS (кат.1), АВ 16А (breaker_min_rating=16 для селективности)
- ЩАО-1: АВ 10А (breaker_min_rating=10), АО-01 — кат.2 в щите кат.2
- ЩОВ-1: АВ 10А (breaker_min_rating=10)
- КРМ: обязательна, батарея КРМ-0.4-10 (10 кВАр)
- Категория здания: 1 (есть кат.1 потребители в ЩАПЗ-1)
- Нарушений селективности: 0 (все panels с breaker_min_rating)
...
# Регистрация ревизии (изменения) — вызывать ПОСЛЕ изменений в project.json и нового calc
python cli.py change projects/DEMO-2025-001_Офисный_центр \
  --desc "Уточнение мощности ОС-01 по заданию" --reason 03 --category load
